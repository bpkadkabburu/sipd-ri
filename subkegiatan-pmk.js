...
let b = require('./JSON/ringkasan-kua-ppas-25-10-2023.json')
let pmk212 = require('./JSON/list-pmk110.json')
    ...
    if(/Puskesmas/.test(key)){
      ...
      for (const keySubkegiatan in listSubkegiatan) {
        if (Object.hasOwnProperty.call(listSubkegiatan, keySubkegiatan)) {
          ...
          let cariSubkegiatanPmk = pmk212.filter(function (item) {
...
XLSX.writeFile(skAllWb, "KUAPPAS-SUBKEGIATAN-25-10-2023.xlsx", {compression: true})
