...
function cekSumberDana(xlf, listPMK, listSumberDanaSIPD, tahun, namaFile) {
    ...
    totalPagu.push([
        ...
        { t: "s", v: "Belanja TAL (Rp)", s: { font: { bold: true, name: "Calibri", sz: 9 } } },
    ]);
    ...
    for (const key in listDinas) {
        if (Object.hasOwnProperty.call(listDinas, key)) {
            ...
            const tagihanCodes = [
                '5.1.02.02.001.00059', // Telepon
                '5.1.02.02.001.00060', // Air
                '5.1.02.02.001.00061', // Listrik
                '5.1.02.02.001.00063', // Internet
                '5.1.02.02.004.00404'  // Sewa Komputer Jaringan
            ];
            ...
            let arrTotalPagu = [
                ...
                { t: "n", v: calculateSum(element.filter(item => tagihanCodes.includes(item['KODE REKENING'])), 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } },
            ];
            ...
            for (const keyListSubkegiatan in listSubkegiatan) {
                if (Object.hasOwnProperty.call(listSubkegiatan, keyListSubkegiatan)) {
                    ...
                    if (subkegiatan[0]['NAMA SUB KEGIATAN'] === 'Penyediaan Gaji dan Tunjangan ASN') {
                        ...
                        arrTotalPagu[2].v = calculateSum(subkegiatan, 'PAGU');
                        ...
                        for (const keyKodeRekening in listKodeRekening) {
                            if (Object.hasOwnProperty.call(listKodeRekening, keyKodeRekening)) {
                                ...
                                // PNS
                                if (keyKodeRekening === '5.1.01.01.001.00001') arrGajiPNS[0] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === '5.1.01.01.002.00001') arrGajiPNS[1] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.003.00001") arrGajiPNS[2] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.004.00001") arrGajiPNS[3] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.005.00001") arrGajiPNS[4] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.006.00001") arrGajiPNS[5] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.007.00001") arrGajiPNS[6] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.008.00001") arrGajiPNS[7] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.009.00001") arrGajiPNS[8] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.010.00001") arrGajiPNS[9] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.011.00001") arrGajiPNS[10] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.02.001.00001") arrGajiPNS[11] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.02.002.00001") arrGajiPNS[12] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.02.003.00001") arrGajiPNS[13] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.02.004.00001") arrGajiPNS[14] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };

                                // P3K
                                if (keyKodeRekening === "5.1.01.01.001.00002") arrGajiP3K[0] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.002.00002") arrGajiP3K[1] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.003.00002") arrGajiP3K[2] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.004.00002") arrGajiP3K[3] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.005.00002") arrGajiP3K[4] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.006.00002") arrGajiP3K[5] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.007.00002") arrGajiP3K[6] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.008.00002") arrGajiP3K[7] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.009.00002") arrGajiP3K[8] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.010.00002") arrGajiP3K[9] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                                if (keyKodeRekening === "5.1.01.01.011.00002") arrGajiP3K[10] = { t: "n", v: calculateSum(kodeRekening, 'PAGU'), s: { font: { name: "Calibri", sz: 9 } } };
                            }
                        }

                        const excluded = ['5.1.01.03.003', '5.1.01.03.004', '5.1.01.03.005']; // todo: excluded in 2025
                        const startsWithValue = '5.1.01.02.006'; // 2024: 5.1.01.03, 2025: 5.1.01.02.06
                    ...
                    if (!/Puskesmas/.test(element[0]['NAMA SUB UNIT'])) {
                        ...
                        if (cariSubkegiatanPmk.length === 1) {
                            ...
                            let valPagu = cariSubkegiatanPmk[0].pagu;
                            let tipePagu = (typeof valPagu === 'number') ? "n" : "s";
                            paguPmk = { t: tipePagu, v: valPagu ?? "-", s: { font: { name: "Calibri", sz: 9 }, alignment: { wrapText: true } } };
                        } else if (cariSubkegiatanPmk.length > 1) {
                            let kodes = extractProperty(cariSubkegiatanPmk, 'kode').map(x => x ?? "-").join(', ');
                            let bidangs = extractProperty(cariSubkegiatanPmk, 'bidang').map(x => x ?? "-").join(', ');
                            let pagus = extractProperty(cariSubkegiatanPmk, 'pagu').map(x => x ?? "-").join(', ');

                            kodePmk = { t: "s", v: kodes, s: { font: { name: "Calibri", sz: 9 }, alignment: { wrapText: true } } };
                            bidangPmk = { t: "s", v: bidangs, s: { font: { name: "Calibri", sz: 9 }, alignment: { wrapText: true } } };
                            paguPmk = { t: "s", v: pagus, s: { font: { name: "Calibri", sz: 9 }, alignment: { wrapText: true } } };
                        }
                    }
    ...
    totalPaguWs["!cols"] = [{ wpx: 125 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 }];
    ...
    const dirPath = path.dirname(`output/${tahun}/${namaFile}`);
...
function mutakhir(xlf, listSumberDanaSIPD) {
    const xlb = fs.readFileSync(xlf);
    const wb = XLSX.read(xlb);
    let listData = XLSX.utils.sheet_to_json(wb.Sheets[wb.SheetNames[0]]);
...
// Main execution process for conversion
function processKonversi() {
    const tahun = '2026';
    const xlf = `./input/excel/${tahun}/rekap5_murni.xlsx`;
    const pmkPath = './input/json/2025/pmk-110-baru.json';
    const sumberDanaPath = `./input/json/${tahun}/sumber_dana.json`;
    let namaFile = 'CONVERT REKAP 5';

    if (!fs.existsSync(xlf)) {
        console.error(`File input tidak ditemukan: ${xlf}`);
        return;
    }

    const listPMK = fs.existsSync(pmkPath) ? require(pmkPath) : [];
    const listSumberDanaSIPD = fs.existsSync(sumberDanaPath) ? require(sumberDanaPath) : [];

    console.log(`Memproses konversi data analisa dari: ${xlf}...`);
    cekSumberDana(xlf, listPMK, listSumberDanaSIPD, tahun, `${namaFile} ${tahun}.xlsx`);
    console.log(`Selesai! File hasil konversi bisa dicek di folder output/${tahun}/`);
}
